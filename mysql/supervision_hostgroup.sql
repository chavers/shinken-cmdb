...
CREATE TABLE `hostgroup` (
  `hostgroup_name` varchar(255) CHARACTER SET latin1 NOT NULL,
  `alias` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `notes` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `notes_url` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `action_url` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `realm` varchar(255) CHARACTER SET latin1 DEFAULT NULL
