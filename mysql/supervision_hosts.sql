...
CREATE TABLE `hosts` (
  `host_name` varchar(250) COLLATE latin1_general_ci DEFAULT NULL,
  `address` varchar(250) COLLATE latin1_general_ci DEFAULT NULL,
  `alias` varchar(250) COLLATE latin1_general_ci DEFAULT NULL,
  `realm` varchar(250) COLLATE latin1_general_ci DEFAULT NULL,
  `vm` int(4) NOT NULL DEFAULT '0',
  `sw` int(4) NOT NULL DEFAULT '0',
  `nedi_node` int(1) NOT NULL DEFAULT '1',
